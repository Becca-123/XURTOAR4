...
@ObjectModel.query.implementedBy: 'ABAP:ZZ1_CL_DNLIST'

define root view entity ZZ1_I_DNLIST2
  as select from    I_DeliveryDocument                            as I_OutboundDelivery
    inner join      I_DeliveryDocumentItem                        as _I_OutboundDeliveryItem on _I_OutboundDeliveryItem.DeliveryDocument = I_OutboundDelivery.DeliveryDocument
...

{
  ...
  key _I_OutboundDeliveryItem.DeliveryDocumentItem                                                                                                                                     as OutboundDeliveryItem,
      _I_OutboundDeliveryItem.HigherLvlItmOfBatSpltItm                                                                                                                                 as HigherLvlItmOfBatSpltItm,
      ...
      I_OutboundDelivery.OverallGoodsMovementStatus                                                                                                                                    as OverallGoodsMovementStatus,
      @Semantics.text: true
      I_OutboundDelivery._OverallGoodsMovementStatus._Text[Language = $session.system_language].OverallGoodsMovementStatusDesc                                                         as OverallGoodsMovementStatusDesc,
      ...
      @Consumption.valueHelpDefinition: [ { entity: { name: 'I_CUSTOMER_VH', element: 'Customer' } } ]
      @ObjectModel.text.element: [ 'CustomerName_rg' ]
      _I_SalesDocument._Partner[ PartnerFunction = 'RG'].Customer                                                                                                                      as Customer_rg,
